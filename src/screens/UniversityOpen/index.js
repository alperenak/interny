...
/*** Styles ***/
import styles from "./universityopen.scss";
...
// Assets
import image from "../../assets/university-Analytics_wait.png";
				...
				<div className={"referrenceLetter"}>
					...
					<div class="container">
						<div style={{ display: 'flex', justifyContent: 'center' }}>
							<img className="referrenceLetter__image" src={image} alt="Open: Analytics" />
						</div>
						<div className={"referrenceLetter__modal"}>
							<div class="row">
								<div class="col-md-12">
									<div className={"referrenceLetter__header"}>Open: Analytics </div>
