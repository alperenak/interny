...
class PostDetail extends Component{
    ...
    onCoverLetterClick = async (app) => {
        ...
        this.props.createModal({ header: 'Cover Letter', content: this.renderCoverLetter });
    };
    ...
    renderApplicants = () => {
        ...
        applicants.forEach((app) => {
            ...
            if (app.isPending) { // when intern applies
                ...
                if (app.isApproved) { // when intern agree
            ...
            } else if (app.isRejected) { // when employer or intern rejcet
                primaryButtonText = 'ACCEPT';
                primaryFunc = () => {};
                ghostButtonText = 'WITHDRAW';
                ghostFunc = () => {};
            ...
            var person = {
                image: (
                    <img src={app.Intern.avatar} alt={'image'}/>
                ),
                name: app.Intern.name+" "+app.Intern.surname,
                buttons:(
                    <div className={"detailButtons"}>
                        <a className={"detailButton"} onClick={() => window.open('/CvPreview/' + app.Cv.id)} href={'/CvPreview/' + app.Cv.id} target="_blank" >
                            <img src={CVIcon} alt={'icon'}/>
                            <div>Curriculum vitae</div>
                        </a>
                        <a className={"detailButton"} onClick={() => this.onCoverLetterClick(app)}>
