    ...
    return (
      <div className={`${styles.auth} ${type === 'login' ? styles.login : ''}`}>
        <div className={styles.inputs_container}>
          ...
          <br />
          <ReCAPTCHA
            sitekey='6Lf8Mt0ZAAAAAKpkS1LT_DCetiBxDbS3FYoGWU42'
            onChange={console.log('ReCAPTCHA SIGNED')}
          />
          <br />
        ...
        <div className={styles.modal}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Interpretation and Definitions</span>
            </p>
            ...
            <p className={styles.p4}>
              ...
              in this Agreement) refers to INTERNY INC., 350 Oakmead Pkwy,
              Sunnyvale, 94085, CA.
            </p>
            <p className={styles.p4}>
            ...
            <p className={styles.p4}>
              <strong>Website</strong> refers to INTERNY Website, accessible
              from <a href='https://www.interny.net'>https://www.interny.net</a>
            </p>
            <p className={styles.p4}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Acknowledgment</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Placing Orders for Goods</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>In-app Purchases</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p1}>
              ...
              Store&apos;s own terms and conditions or in your Device&apos;s
              Help settings.
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Promotions</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>User Accounts</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Content</span>
            </p>
            <p className={styles.p3}>
            ...
            <ul className={styles.ul1}>
              ...
              <li className={styles.li1}>
                Spam, machine &ndash; or randomly &ndash; generated,
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Copyright Policy</span>
            </p>
            <p className={styles.p3}>
            ...
            <p className={styles.p1}>
              ...
              attention of our copyright agent via email at info@interny.net and
            ...
            <p className={styles.p1}>
              You can contact our copyright agent via email at info@interny.net.
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Intellectual Property</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Your Feedback to Us</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Links to Other Websites</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Termination</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Limitation of Liability</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Governing Law</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Disputes Resolution</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>For European Union (EU) Users</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>United States Legal Compliance</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Severability and Waiver</span>
            </p>
            <p className={styles.p3}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Translation Interpretation</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p2}>
              <span className={styles.s1}>Contact Us</span>
            </p>
            <p className={styles.p1}>
            ...
            <p className={styles.p4}>
              ...
              <a href='https://www.interny.net/help'>
                https://www.interny.net/help
              </a>
            </p>
          </div>
        </div>
  ...
  renderPrivacyPolicy = () => {
    return (
      <div
        ...
        onClick={this.onOutsideClickPrivacyPolicy}
      >
        <div className={styles.modal}>
          <div className={styles.closeModalButton}>
            <img src={closeIcon} alt='' />
          ...
          <div className={styles.content}>
            ...
            <p class={styles.p2}>
              <span class={styles.s1}>Interpretation and Definitions</span>
            </p>
            <p class={styles.p3}>
              <strong>Interpretation</strong>
            </p>
            ...
            <p class={styles.p4}>
              ...
              Interny Inc. specifically created by the Company on the Facebook
              social network, accessible from{' '}
              <a href='https://www.facebook.com/internynet/'>
                https://www.facebook.com/internynet/
              </a>
            </p>
            <p class={styles.p4}>
            ...
            <p class={styles.p3}>
              <strong>Usage, Performance and Miscellaneous</strong>
            </p>
            <p class={styles.p1}>
            ...
            <p class={styles.p2}>
              <span class={styles.s1}>GDPR Privacy</span>
            </p>
            <p class={styles.p3}>
              <strong>
            ...
            <p class={styles.p2}>
              <span class={styles.s1}>Facebook Fan Page</span>
            </p>
            <p class={styles.p3}>
            ...
            <p class={styles.p2}>
              <span class={styles.s1}>CCPA Privacy</span>
            </p>
            <p class={styles.p3}>
            ...
            <p class={styles.p2}>
              <span class={styles.s1}>Links to Other Websites</span>
            </p>
            <p class={styles.p1}>
            ...
            <p class={styles.p2}>
              <span class={styles.s1}>Changes to this Privacy Policy</span>
            </p>
            <p class={styles.p1}>
            ...
            <p class={styles.p2}>
              <span class={styles.s1}>Contact Us</span>
            </p>
            <p class={styles.p1}>
