    ...
    return (
      <div className={"companyProfileCard"}>
        <div className={"profileImage"}>
          <div
            v-if={profileObject.avatar || profileObject.logo}
            className={"imageContainer"}
          >
            <img
              src={profileObject.avatar || profileObject.logo}
              alt={"profile photo"}
            />
          </div>
          <label
            ...
            className={
              profileObject.avatar || profileObject.logo
                ? "statusCircle"
                : "fileInput"
            }
            htmlFor="fileInput"
        ...
        <div className={"headerText"}>{profileObject.header}</div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: profileObject.description }}
        ></div>
      </div>
    );
  }
